# -*- coding: utf-8 -*-
"""
Django settings for julianschwazer project.
...
SERVER_EMAIL = "django@julianschwazer.at"
...
ROOT_URLCONF = "julianschwazer.urls"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "julianschwazer.context_processors.globals",
            ]
        },
    }
]
...
EMAIL_SUBJECT_PREFIX = "[julianschwazer.at] "
...
COMPRESS_PRECOMPILERS = [
    ...
    ("text/x-scss", "julianschwazer.compressor_filters.PatchedSCSSCompiler"),
]
...
CKEDITOR_CONFIGS = {
    "default": {
        "contentsCss": "%sjulianschwazer/css/rte.css?v=%s" % (STATIC_URL, VERSION),
        "customConfig": "%sjulianschwazer/js/rte.js?v=%s" % (STATIC_URL, VERSION),
...
THUMBNAIL_PROCESSORS = (
    ...
    # 'julianschwazer.processors.gauss',
)
...
CMSTOOLS_INTERNALLINKS_HANDLERS = [
    ...
    "julianschwazer.views.InternalActionsLinks",
]
