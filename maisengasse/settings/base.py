# -*- coding: utf-8 -*-
"""
Django settings for maisengasse project.
...
SERVER_EMAIL = "django@maisengasse.at"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "maisengasse.context_processors.globals",
            ]
        },
    }
]
...
EMAIL_SUBJECT_PREFIX = "[maisengasse.at] "
...
COMPRESS_PRECOMPILERS = [
    ...
    ("text/x-scss", "maisengasse.compressor_filters.PatchedSCSSCompiler"),
]
...
CKEDITOR_CONFIGS = {
    "default": {
        "contentsCss": "%smaisengasse/css/rte.css?v=%s" % (STATIC_URL, VERSION),
        "customConfig": "%smaisengasse/js/rte.js?v=%s" % (STATIC_URL, VERSION),
...
CMSTOOLS_INTERNALLINKS_HANDLERS = [
    ...
    "maisengasse.views.InternalActionsLinks",
]
