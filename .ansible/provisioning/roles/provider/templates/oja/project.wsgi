#!/home/xadmin/envs/{{ project_name }}/bin/python
import os
import sys
import site
site.addsitedir('/home/xadmin/envs/{{ project_name }}/lib/python2.7/site-packages')

paths = [
  '/home/xadmin/django/{{ project_name }}/{{ project_name }}',
]
for path in paths:
...
UPGRADING = False#True
project_dir = "/home/xadmin/django/{{ project_name }}/{{ project_name }}"
