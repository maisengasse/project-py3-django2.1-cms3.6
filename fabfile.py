...
REMOTE_USER = "maisengasse"
REMOTE_PATH = "/web/maisengasse/home/projects/maisengasse"
REMOTE_DB = "maisengassedb1"
REMOTE_MEDIA = [
    REMOTE_PATH + "/media/filer_public/",
    # REMOTE_PATH + "/media/ckeditor/"
]
LOCAL_PATH = "/home/vagrant/maisengasse"
LOCAL_DB = "maisengasse"
LOCAL_MEDIA = [
    LOCAL_PATH + "/media/filer_public/",
    # LOCAL_PATH + '/src/maisengasse/media/ckeditor/'
]
...
@task
def db_from_dump(c, dumpfile="maisengasse.sync.sql", gzip=False):
    with local.cd(LOCAL_PATH):
...
@task
def get_remote_dump(c, dumpfile="maisengasse.sync.sql", gzip=False):
...
@task
def sync_down(c, dumpfile="maisengasse.sync.sql"):
